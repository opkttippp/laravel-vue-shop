...
//--------------------------------Roles-----------------------------------------
Route::group(['prefix' => '/admin/roles', 'middleware' => ['role:manager|admin'], 'controller'  => RoleController::class], function(){
...
Route::group(['prefix' => '/admin/users', 'middleware' => ['role:admin'], 'controller' => UserController::class], function () {
        Route::get('/', 'index')->middleware('can:show post');
