...
<!--                        <a href="{{ product.stock > 0 ? route('cart.add', ['productId' => $product->id]) : '#' }}"-->
        ...
        <div v-show="amountPage > 1"
            ...
            <ul class="pagination-ul">
                <li v-if="page > 2" class="pagination-li" @click.stop="changePage(1)"
                ...
                <li v-if="page === amountPage - 3 && amountPage > 4" class="pagination-li" @click.stop="changePage(amountPage)"
                    :class="[ page !== item ? '' : 'current']">
                    {{ amountPage - 1 }}
                </li>
                <li v-if="page < amountPage - 1" class="pagination-li" @click.stop="changePage(amountPage)"
                    :class="[ page !== item ? '' : 'current']">
                    {{ amountPage }}
                </li>
            </ul>
